...
public class Deep_Auto extends LinearOpMode {
    ...
    private static final double TICKS_PER_REV = 366.8;
    private static final double MAX_RPM = 458.01;
    private static final int COUNTS_PER_MOTOR_REV = 28;
    private static final int DRIVE_GEAR_REDUCTION = 13;
    private static final double WHEEL_DIAMETER_INCHES = 3.7;
    private static final double WHEEL_RADIUS = 1.9698; // in
    private static final double GEAR_RATIO = 13.1; // output (wheel) speed / input (motor) speed
    private static final double TRACK_WIDTH = 16; // in
    ...
    private void driveStraight(double maxDriveSpeed, int distance, int heading) {
        ...
        if (opModeIsActive()) {
            ...
            leftBack.setTargetPosition((int) leftTarget);
            rightFront.setTargetPosition((int) rightTarget);
            rightBack.setTargetPosition((int) rightTarget);
